...
//const auto PROPERTYTYPES_SQL = QLatin1String(R"(
//    create table propertyTypes(id integer primary key, name varchar)
//    )");
...
//const auto INSERT_PROPERTYTYPE_SQL = QLatin1String(R"(
